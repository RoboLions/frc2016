 ...
 *
 */
public class ReachAutonomousProgram extends CommandGroup {
	
	public static final double SHOOTER_ARM_POSITION = ShooterArm.SETPOINT_HORIZONTAL_POSITION;
	public static final double DRIVE_FORWARD_TIME = 0.75;
    
    public  ReachAutonomousProgram() {
        // Add Commands here:
		...
		addSequential(new DriveForward(DRIVE_FORWARD_TIME));
    }
}
